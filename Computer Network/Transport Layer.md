...
![UDP Header Structure](../assets/network-udp-header-structure.jpeg)
...
<img src="../assets/network-stop-and-wait-arq.png" alt="Stop and Wait ARQ Protocol" style="zoom:50%;" />
...
<img src="../assets/network-sliding-window-go-back-n.jpg" alt="Go-Back-N Sliding Window Protocol" style="zoom:50%;" />
...
<img src="../assets/network-sliding-window-selective-repeat.jpg" alt="Selective Repeat Sliding Window Protocol" style="zoom:50%;" />
...
![TCP Header Structure](../assets/network-tcp-header-structure.png)
...
![TCP Connection Establishment (Three-Way Handshake)](../assets/network-tcp-connection-establishment.png)
...
![TCP Connection Termination](../assets/network-tcp-connection-termination.png)
