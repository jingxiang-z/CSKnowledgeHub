...
![Process Structure](../assets/os-process-structure.png)
...
![Linux Kernel task_struct](../assets/os-task-struct-linux.png)
...
<img src="../assets/os-process-lifecycle.png" alt="Process Lifecycle States" style="zoom: 67%;" />
